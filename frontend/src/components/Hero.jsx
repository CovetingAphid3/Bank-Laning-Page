  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-row items-center py-[6px] px-4 bg-black-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white font-bold font-roboto">20%</span>{" "}
            Discount For{" "}
            <span className="text-white font-bold font-roboto">1 Month</span>{" "}
            Account
          </p>
        </div>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts ensures hassle-free trading by offering a range of
          secure payment methods. We prioritize your needs and consider factors
      ...
      >
        <a
          href="#product"
          className="bottom-10 w-[70%] h-[70%] relative z-[5] hover:bg-white rounded-full cursor-pointer transition-all duration-300 ease-in-out"
        >
          <img src={bitcoin} alt="billing" />
        </a>
      </div>
    </section>
  );
